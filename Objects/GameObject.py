...
class Agobject(S_MonoBehaviour):
    def __init__(self):
        ...
        self.anims = {'Idle': (10, 'MusicGame\\Assets\\GG_Anim\\IDLE.png', 0.5, True),
                    ...
                    'Attack': (7, 'MusicGame\\Assets\\GG_Anim\\ATTACK 1.png', 0.5, False),
    ...
    def Update(self):
        if self.GameObject[2].Time['Index'] == 1:
            ...
            for i in self.Input:
                ...
                if i == 1025 and self.Input[i]:
                    self.feel['frame'] = 0
                    self.feel['anim'] = 'Attack'
                    self.AnimU()
                if self.Input[i]: break

        if self.anims[self.feel['anim']][0] - 1 == self.feel['frame'] and self.anims[self.feel['anim']][3]:
            print('a')
            self.feel['anim'] = 'Idle'
            self.feel['frame'] = 0
            self.AnimU()
